...
import { ShieldCheck, Star, Download, Zap, ArrowLeft, Copy, Send } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans pb-20">
      ...
      <main className="max-w-6xl mx-auto px-6 pt-32 lg:pt-40">
        ...
        {/* Mission overview and Related apps skipped here for length, keep your existing ones */}
      </main>
              ...
              <div className="bg-white/5 p-12 rounded-[3.5rem] mb-8 shadow-inner border border-white/5">
                {!isReady ? (
                  ...
                  <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }}>
                    ...
                    <button 
                      onClick={() => window.location.assign(app.download_url)}
