...
// ThemeToggle ko yahan se bhi hata diya gaya hai, kyunki theme lock ho chuka hai
// Import line of ThemeToggle is removed
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-[#050505] text-gray-900 dark:text-white transition-colors duration-300 font-sans pb-20">
      <nav className="p-4 border-b border-gray-200 dark:border-white/5 flex justify-between items-center bg-white/90 dark:bg-[#121212]/90 backdrop-blur-md sticky top-0 z-50">
        ...
        {/* ThemeToggle ko yahan se hata diya gaya hai */}
      </nav>

      <main className="max-w-2xl mx-auto px-6 py-12 text-center">
        
        {/* ADS SLOT 1 (orbit_download_top - 4335224302) */}
        <div className="mb-10 w-full mx-auto">
          <ins 
            className="adsbygoogle"
            style={{ display: 'block' }}
            data-ad-client="ca-pub-6036065566084740" 
            data-ad-slot="4335224302" // <--- YOUR TOP AD SLOT
            data-ad-format="auto"
            data-full-width-responsive="true"
          />
          {/* Ad code ko push karna */}
        ...
        {/* ADS SLOT 2 (orbit_download_bottom - 7507456203) */}
        <div className="mt-10 w-full mx-auto">
          <ins 
            className="adsbygoogle"
            style={{ display: 'block' }}
            data-ad-client="ca-pub-6036065566084740" 
            data-ad-slot="7507456203" // <--- YOUR BOTTOM AD SLOT
            data-ad-format="auto"
            data-full-width-responsive="true"
          />
          {/* Ad code ko push karna */}
